...
public class FileDownloaderSSL {
	
	private static String downloadPath = "D:/DataFournisseur/";
	 public static String fileDownloader(WebDriver driver,String url, Integer timeout) throws Exception {
